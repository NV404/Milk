...
var handlePush = (event) => {
  ...
  const data = JSON.parse(
    (_a = event == null ? void 0 : event.data) == null ? void 0 : _a.text()
  );
  const title = data.title ? data.title : "Remix PWA";
  const options = {
    body: data.body ? data.body : "Notification Body Text",
    icon: data.icon ? data.icon : "/icons/android-192x192.png",
    badge: data.badge ? data.badge : "/icons/android-48x48.png",
